...
class PropagationTerms:
    """
    # PropagationTerms
    This class is used to calculate any terms related to propagation through the medium
    The medium should be homogeneus with refractive indez n(ω)
    ## Note:
    ...
    def propagation(self):
        """
        Propagation term trough the medium
        """
    ...
    def fabry_perot(self, num_of_terms="all"):
        """
        Calculate the Frabry-Pérot term of the transmission function
    ...
    def total_propagation_term(self):
        """
        Calculate the total propagation coefficient trough de medium
        """
